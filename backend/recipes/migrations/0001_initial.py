# Generated by Django 5.1.5 on 2025-01-28 16:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveBigIntegerField(validators=[django.core.validators.MinValueValidator(1)], verbose_name='Количество')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['id'],
                'constraints': [models.UniqueConstraint(fields=('user', 'recipe'), name='unique_user_favorite')],
            },
        ),
